  ...
  getDefaultData() {
    return {
      users: [
        ...
        { id: "USR-102", username: "resident1", name: "Amit Patel", role: "Resident", status: "Approved", tower: "Tower A", flat: "A-302", flatNo: "A-302", residentType: "Owner", rentAmount: "₹18,000/month", maintenanceDues: "₹3,500/month", parkingSlot: "P-14", block: "Phase 1", moveInDate: "2024-01-15", familyCount: "3 Members", email: "amit.patel@gmail.com", phone: "9812345678", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Amit", vehicles: ["MH 02 EQ 8829 (SUV)", "MH 02 CB 1029 (Bike)"], familyMembers: ["Priya Barad (Spouse)", "Kavya Barad (Child)"] },
        { id: "USR-103", username: "resident2", name: "Priya Verma", role: "Resident", status: "Approved", tower: "Tower C", flat: "C-501", flatNo: "C-501", residentType: "Tenant", rentAmount: "₹22,000/month", maintenanceDues: "₹4,000/month", parkingSlot: "P-22", block: "Phase 2", moveInDate: "2024-03-01", familyCount: "2 Members", email: "priya.v@gmail.com", phone: "9823456789", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Priya", vehicles: ["MH 04 AX 4410 (Sedan)"], familyMembers: ["Rohan Verma (Spouse)"] },
        ...
        { id: "USR-105", username: "committee", name: "Suresh Kumar", role: "Committee Member", status: "Approved", flat: "A-402", email: "suresh@smartsociety.com", phone: "9765432109", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Suresh" }
      ],
      complaints: [],
      maintenance: [],
      visitors: [],
